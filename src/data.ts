...
export const servers: Server[] = [
  {
    ...
    components: [
      ...
      },
      {
        ...
        version: "1.5.0",
        commit: "jkl012",
        packageDependencies: [{ name: "dep3", commit: "mno345" }],
        binaryDependencies: [{ name: "bin3", version: "1.0.0" }],
      },
      {
        ...
        commit: "pqr678",
        dependencies: [
          { name: "dep1", commit: "vwx232" },
          { name: "dep2", commit: "yz0563" },
        ],
  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        ...
        version: "2.0.0",
        commit: "abc890",
        packageDependencies: [{ name: "dep3", commit: "def123" }],
        binaryDependencies: [{ name: "bin3", version: "1.5.0" }],
      },
      {
